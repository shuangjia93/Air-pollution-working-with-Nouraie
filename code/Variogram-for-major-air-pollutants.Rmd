...
# SO2
```{r, message=FALSE, warning=FALSE, echo=F}
SO2_Krig <- data.frame(zipcodes) # can change to subject IDs 
...
for (i in 2:ncol(SO2)) {
  ...
  SO2.kriged <-krige(SO2_tmp ~ 1, known_na_omit, unknowndt, model = FittedModel.SO2, maxdist=10, nmax=50)
  SO2_Krig[,i] <- SO2.kriged$var1.pred
  colnames(SO2_Krig)[i] <- date
